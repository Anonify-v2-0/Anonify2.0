...
export const PROVIDERS: ProviderDefinition[] = [
  ...
  },
  {
    ...
    languageModel: async (env, fetch) =>
      (await import("@ai-sdk/google")).createGoogle({
  ...
  },
  {
    ...
    languageModel: async (env, fetch) =>
      (await import("@ai-sdk/xai")).createXai({
  ...
  },
  {
    ...
    languageModel: async (env, fetch) =>
      (await import("@ai-sdk/cohere")).createCohere({
  ...
  },
  {
    ...
    fields: ["FIREWORKS_ACCOUNT_ID"],
    modelsUrl: "https://api.fireworks.ai/v1/accounts/fireworks/models",
    languageModel: async (env, fetch) =>
      (await import("@ai-sdk/fireworks")).createFireworks({
  ...
  },
  {
    ...
    modelsUrl: "https://api.deepinfra.com/models/list",
    languageModel: async (env, fetch) =>
  ...
  },
  {
    ...
    languageModel: async (env, fetch) =>
      (await import("@ai-sdk/groq")).createGroq({
  ...
  },
  {
    ...
    languageModel: async (env, fetch) =>
      (await import("@ai-sdk/baseten")).createBaseten({
  ...
  },
  {
    ...
    languageModel: async (env, fetch) =>
      (await import("@ai-sdk/azure")).createAzure({
  ...
  },
  {
    ...
    languageModel: async (env, fetch) => {
      ...
      return createAmazonBedrock({
        ...
        credentialProvider: () => client.config.credentials(),
        fetch,
      })(modelId(env))
    },
  },
  {
    ...
    languageModel: async (env, fetch) =>
      (await import("@ai-sdk/google-vertex")).createGoogleVertex({
...
export function selectedProvider(
  ...
  if (!provider)
    throw new Error(
      "Unsupported AI_PROVIDER; choose a provider with pnpm setup"
    )
  return provider
}
...
export async function languageModel(
  ...
  if (!modelId(env))
    throw new Error("AI_MODEL is required for the selected provider")

  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-60">
        {/*
          The label names the options, so it has to live in the group it names:
          Base UI wires the two together with aria-labelledby and refuses a
          GroupLabel with no Group around it.
        */}
        <DropdownMenuGroup>
